...
def LoadSystemIncludes():
    regex = re.compile(
        r'(?:\#include \<...\> search starts here\:)(?P<list>.*?)(?:End of search list)', re.DOTALL)
...
database = None if not os.path.exists(
    compilation_database_folder) else ycm_core.CompilationDatabase(compilation_database_folder)
flags = [
    '-Wall',
    '-std=c++11',
    '-stdlib=libc++',
...
def FlagsForFile(filename, **kwargs):
    if database:
        ...
        final_flags = MakeRelativePathsInFlagsAbsolute(
            compilation_info.compiler_flags_, compilation_info.compiler_working_dir_) + systemIncludes
    else:
